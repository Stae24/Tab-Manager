...
export const Dashboard: React.FC = () => {
  ...
  const deleteEmptyVaultGroups = useStore(state => state.deleteEmptyVaultGroups);
  ...
  return (
    <div
      ...
      className={cn('flex flex-col select-none overflow-hidden fixed top-0 left-0 z-0 bg-gx-dark text-gx-text', isDarkMode ? 'dark' : 'light')}
      style={{
              ...
              {showVault && (
                <>
                  ...
                  <VaultPanel
                    ...
                    deleteEmptyVaultGroups={deleteEmptyVaultGroups}
